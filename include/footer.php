                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                        <div class="logo-widget footer-widget">
                            <div class="footer-title"><?php echo $lang['footerATitle'] ?></div>
                            <div class="text">
                                <p><?php echo $lang['footerA'] ?></p>
                                <p><?php echo $lang['footerB'] ?></p>
                                <p><?php echo $lang['footerC'] ?></p>
                                <p><?php echo $lang['footerD'] ?></p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 column">
                    <div class="copyright"><a href="<?php echo $lang['toEnter'] ?>">KNOWGOD</a>&copy; 2021 <?php echo $lang['reserved'] ?></div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12 column">
                    <ul class="footer-nav">
