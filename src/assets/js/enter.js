$(document).ready( function enter(){
    ...
    $('.efectoMCH').delay(1000).queue(function(displayBlock){$(this).css('display', 'block');displayBlock();});
    ...
    $('.efectoMTCH').delay(5200).queue(function(displayBlockB){$(this).css('display', 'block');displayBlockB();});
    ...
    $('.efectoMThreeCH').delay(9500).queue(function(displayBlockC){$(this).css('display', 'block');displayBlockC();});
    ...
    $('.efectoMFCH').delay(12000).queue(function(displayBlockD){$(this).css('display', 'block');displayBlockD();});
...
/*      $('.efectoM').delay(14000).queue(function(dissappear){$(this).addClass('dissappear');dissappear();});
    ...
    $('.efectoMCH').delay(14000).queue(function(dissappear){$(this).addClass('dissappear');dissappear();});
    $('.efectoMTCH').delay(10000).queue(function(dissappearB){$(this).addClass('dissappear');dissappearB();});
    $('.efectoMThreeCH').delay(6000).queue(function(dissappearC){$(this).addClass('dissappear');dissappearC();});
    $('.efectoMFCH').delay(4000).queue(function(dissappearD){$(this).addClass('dissappear');dissappearD();});
