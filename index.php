...
<!-- boxes -->
      ...
      <div class="box">
        ...
        <span class="one"></span>
        <span class="two"></span>
        <div class="content" onmousedown="languageSelect()" onmouseup="languageSelectOff()">
            <div class="inBox">
            <span class="one"></span>
            <span class="two"></span>
            <span class="one"></span>
            <span class="two"></span>
            <div class="selectCH">中文</div>
            </div>
        </div>
      ...
      <div class="box-B">
        ...
        <span class="one"></span>
        <span class="two"></span>
        <div class="content" onmousedown="languageSelectB()" onmouseup="languageSelectBOff()">
            <div class="inBox-B">
            <span class="one"></span>
            <span class="two"></span>
            <span class="one"></span>
            <span class="two"></span>
            <div class="selectES">Español</div>
            </div>
        </div>
